...
class OrderDAO extends BaseDAO{
  ...
  function getOrderListGroupByTableInArea($area_id=-1){
    ...
    if($area_id>0){
      ...
      //get all
      $sql='SELECT	o.*,t.name as table_name,sum(o.count) as count_sum,sum(o.price) as price_sum FROM orders o INNER JOIN tables t ON t.id = o.table_id GROUP BY o.number_id ORDER BY o.order_time DESC;';
    }
